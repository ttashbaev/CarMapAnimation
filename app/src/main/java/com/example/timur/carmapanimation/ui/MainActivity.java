        ...
        import com.example.timur.carmapanimation.config.PermissionUtils;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, SphericalUtil.computeDistanceBetween(mStartPosition,mEndPosition) + " ", Toast.LENGTH_LONG).show();
...
//                        }
//                        prevRotate = hearing;
                        mCarMarker.setRotation((float)SphericalUtil.computeHeading(mStartPosition,mEndPosition) - 50);
